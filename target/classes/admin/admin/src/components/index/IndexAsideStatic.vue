<template>
  <el-aside class="index-aside" height="100vh" width="210px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#FF8C00">
        <div class="menulistImg" style="backgroundColor:block;padding:25px 0" v-if="false && menulistStyle == 'vertical'">
          <el-image v-if="''" src="" fit="cover" />
        </div>
        <el-menu mode="horizontal" :unique-opened="false" class="el-menu-demo" style="height:100%;" background-color="#FFF0F5" text-color="#080808" active-text-color="#000000" default-active="0">
